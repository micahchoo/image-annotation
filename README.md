...
![An image region attached to the real note His Eyes Sparkle](https://raw.githubusercontent.com/micahchoo/image-annotation/0.1.2/docs/image-annotation.png)
...
![Right-click an image, draw a region, add a title, save, attach to His Eyes Sparkle, and preview the caption](https://raw.githubusercontent.com/micahchoo/image-annotation/0.1.2/docs/right-click-workflow.gif)
